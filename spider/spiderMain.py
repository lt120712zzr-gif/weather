...
import sys
import re
os.environ.setdefault('DJANGO_SETTINGS_MODULE','天气数据分析可视化系统.settings')
django.setup()
...
class SpiderMain():
    def __init__(self,city):
        ...
        # self.dateList = ['202301','202302','202303','202304','202305','202306','202307','202308','202309','202310','2023011','202312']
        self.dateList = [ '2023011','202312']
        self.headers = {
    ...
    def save_to_sql(self):
        ...
        for weather in data:
            WeatherInfo.objects.create(
                averageHeight=weather[0],
                averageSmall=weather[1],
                mastHeight=weather[2],
                mastSmall=weather[3],
                averageAir=weather[4],
                mastAir=weather[5],
                lostAir=weather[6],
                date=weather[7],
                weekDay=weather[8],
                mastHeightDay=weather[9],
                mastSmallDay=weather[10],
                wearther=weather[11],
                wind=weather[12],
                windOrder=weather[13],
                city=weather[14]
...
if __name__ == '__main__':
    ...
    # spiderMainObj = SpiderMain('北京')
    # spiderMainObj.save_to_sql()
